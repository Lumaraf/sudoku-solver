...
func (s *sudoku) GuessSolutionsWith(ctx context.Context, guesser Guesser, factories ...SolverFactory) func(func(Sudoku) bool) {
...
func (s *sudoku) guessSolutions(solvers []Solver, guesser Guesser, path []CellLocation, ctx context.Context) func(yield func(sudoku) bool) {
	s.stats.GuesserRuns++
	return func(yield func(sudoku) bool) {
		baseClone := *s
